...
const SRC = '/root/telomx-mes-ontology/ARCHITECTURE.html';
const OUT = '/root/telomx-mes-ontology/pdf/텔롬엑스-MES-시스템아키텍처-r1.0.pdf';
(async () => {
  ...
  await page.pdf({ path: OUT, format: 'A4', printBackground: true, preferCSSPageSize: true,
    ...
    footerTemplate: '<div style="font-size:7pt;width:100%;text-align:center;color:#888">TelomX · MES 계층 아키텍처 TX-ARCH r1.0 · <span class="pageNumber"></span>/<span class="totalPages"></span></div>' });
  await browser.close();
  console.log(OUT);
})();
