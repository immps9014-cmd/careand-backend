...
const OUT = '/root/telomx-mes-ontology/pdf/텔롬엑스-MES-온톨로지MCP-워크플로-r1.0.pdf';
(async () => {
  ...
  await page.pdf({ path: OUT, format: 'A4', printBackground: true, preferCSSPageSize: true,
    ...
    footerTemplate: '<div style="font-size:7pt;width:100%;text-align:center;color:#888">TelomX · 온톨로지 MCP 워크플로 TX-FLOW r1.0 · <span class="pageNumber"></span>/<span class="totalPages"></span></div>' });
  await browser.close();
  console.log(OUT);
})();
