...
const OUT = '/root/hisense-docs/히센스-수주작업지시-화면정리안-r1.1.pdf';
(async () => {
  ...
  await page.pdf({ path: OUT, format: 'A4', printBackground: true, preferCSSPageSize: true,
    ...
    footerTemplate: '<div style="font-size:7pt;width:100%;text-align:center;color:#888">TelomX · 히센스 수주·작업지시 화면 정리안 HS-UX-01 r1.1 · <span class="pageNumber"></span>/<span class="totalPages"></span></div>' });
  await browser.close();
  console.log(OUT);
})();
